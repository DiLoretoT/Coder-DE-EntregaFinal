...
from scripts.utils import connect_to_db, load_to_sql, enviar
import pytz
import psycopg2
...
def load_to_redshift_combined(**kwargs):
    ...
    if final_df is not None and not final_df.empty:
        with engine.connection() as conn:
            # conn.execute(text("TRUNCATE TABLE tomasmartindl_coderhouse.stg_bcra"))
